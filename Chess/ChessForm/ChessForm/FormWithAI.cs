    ...
    public partial class FormWithAI : Form
    {
        ...
        public void DrawPiece(ChessBoard Board)
        {
            ...
            if (Player0MovesCount > 1 && Player0MovesCount > 1)
                ...
                {
                    System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"D:\Chess-Project-for-IT007-main - Copy\Chess\ChessForm\Resources\Wav\Eat.wav");
                    player.Play();
                    MessageBox.Show($"Check Mate Player {Math.Abs(PlayerXMadelastMoved - 1)}", "CHECK MATE!!!");
                    this.Close();
                    System.Media.SoundPlayer player1 = new System.Media.SoundPlayer(@"D:\Chess-Project-for-IT007-main - Copy\Chess\ChessForm\Resources\Wav\Opening.wav");
                    player1.Play();
                }
        ...
        private void Board_Click(object sender, EventArgs e)
        {
            ...
            if (!(butt.Tag is ChessPiece))
            {
                ...
                if (selectedPlayer > -1)
                {
                    ...
                    if (playerMoved)
                    {
                        System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"D:\Chess-Project-for-IT007-main - Copy\Chess\ChessForm\Resources\Wav\Move.wav");
                        player.Play();
                        CountPlayerMoved();
                    }
                    selectedPlayer = -1;
